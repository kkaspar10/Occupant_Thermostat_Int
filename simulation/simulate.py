...
from occ_agent import FullPowerHeatPumpRBC, ZeroPowerHeatPumpRBC
from occ_reward import AverageComfortReward, MinimumComfortReward
...
class CityLearnSimulation:
    @staticmethod
    def simulate(
        level_of_detail: int, library: str, agent: str, simulation_id_suffix: str = None, central_agent: bool = None, random_seed: int = None, reward_function: str = None, rbc: str = None, 
        ...
        env, agent = CityLearnSimulation.learn(
            level_of_detail, library, agent, central_agent=central_agent, random_seed=random_seed, reward_function=reward_function, 
            rbc=rbc, episodes=episodes, episode_time_steps=train_episode_time_steps
        )
        train_end_timestamp = datetime.utcnow()
        evaluation_start_timestamp = datetime.utcnow()
        env, agent = CityLearnSimulation.evaluate(library, env, agent, episode_time_steps=evaluation_episode_time_steps)
    ...
    @staticmethod
    def evaluate(library: str, env: OCCCityLearnEnv, agent: Any, episode_time_steps: List[int] = None) -> Tuple[OCCCityLearnEnv, Any]:
    ...
    @staticmethod
    def learn(
        level_of_detail: int, library: str, agent: str, central_agent: bool = None, random_seed: int = None, 
        reward_function: str = None, rbc: str = None, episodes: int = None, episode_time_steps: List[List[int]] = None
    ) -> Tuple[OCCCityLearnEnv, Any]:
        env, agent = CityLearnSimulation.get_agent(
            level_of_detail, library, agent, central_agent=central_agent, random_seed=random_seed, 
            reward_function=reward_function, rbc=rbc, episode_time_steps=episode_time_steps
        )
        kwargs = {}
    ...
    def get_agent(
        level_of_detail: int, library: str, agent: str, central_agent: bool = None, random_seed: int = None, 
        reward_function: str = None, rbc: str = None, episode_time_steps: List[List[int]] = None
    ) -> Tuple[OCCCityLearnEnv, Any]:
